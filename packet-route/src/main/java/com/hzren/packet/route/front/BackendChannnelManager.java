...
class BackendChannnelManager {
    ...
    static {
        worker.scheduleAtFixedRate(new BackendChannelLifeCycleTask(), 100, 100, TimeUnit.MILLISECONDS);
    }
    ...
    static void startChannel(){
        Bootstrap bootstrap = new Bootstrap()
                ...
                .handler(new BackendChannelInitializer());
        try {
